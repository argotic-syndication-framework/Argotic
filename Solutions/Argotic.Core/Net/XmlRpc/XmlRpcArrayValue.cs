...
[Serializable]
public class XmlRpcArrayValue : IXmlRpcValue, IComparable, IEquatable<XmlRpcArrayValue>
{
    /// <summary>
    ...
    public XmlRpcArrayValue(XPathNodeIterator iterator)
    {
        ...
        if (iterator.Count > 0)
        {
            ...
            {
                if (XmlRpcClient.TryParseValue(iterator.Current, out IXmlRpcValue value))
                {
