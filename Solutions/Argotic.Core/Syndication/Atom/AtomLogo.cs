...
/// </example>
[Serializable]
public class AtomLogo : IAtomCommonObjectAttributes, IComparable, IEquatable<AtomLogo>, IExtensibleSyndicationObject
{
    /// <summary>
    ...
    {
        return obj is AtomLogo other && this.Equals(other);
    }
