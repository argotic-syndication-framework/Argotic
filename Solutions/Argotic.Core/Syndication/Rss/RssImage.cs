...
/// </example>
[Serializable]
public class RssImage : IComparable<RssImage>, IEquatable<RssImage>, IExtensibleSyndicationObject, IComparisonOperators
{

    /// <summary>
    /// Private member to hold the URL of the website represented by the image.
    /// </summary>
