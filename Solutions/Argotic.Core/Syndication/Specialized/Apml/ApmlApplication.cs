namespace Argotic.Syndication.Specialized
{
    ...
    ///         <code
    ///             source="..\..\Documentation\Microsoft .NET 3.5\CodeExamplesLibrary\Core\Apml\ApmlApplicationExample.cs"
    ...
    public class ApmlApplication : IComparable, IExtensibleSyndicationObject
    {
        ...
        public string Data
        {
            ...
            set
            {
                ...
                {
                    this.applicationData = string.Empty;
                }
                else
                {
                    this.applicationData = value.Trim();
                }
            }
        }
