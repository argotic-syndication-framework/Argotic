namespace Argotic.Syndication.Specialized
{
    ...
    ///         <code source="..\..\Argotic.Examples\Core\Apml\ApmlApplicationExample.cs" region="ApmlApplication" />
    ///     </code>
    /// </example>
    ...
    public class ApmlApplication : IComparable, IExtensibleSyndicationObject
    {
        ...
        public string Data
        {
            ...
            set
            {
                this.applicationData = string.IsNullOrEmpty(value) ? string.Empty : value.Trim();
            }
        }
