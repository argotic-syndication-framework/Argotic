    ...
    public class BlogMLCategory : IBlogMLCommonObject, IComparable, IExtensibleSyndicationObject
    {
        ...
        public string Description
        {
            ...
            set
            {
                ...
                {
                    this.categoryDescription = value.Trim();
                }
            }
        }
        ...
        public string ParentId
        {
            get
            {
                return this.categoryParentIdentifier;
            }
            ...
            set
            {
                if (string.IsNullOrEmpty(value))
                {
                    this.categoryParentIdentifier = string.Empty;
                }
                else
                {
                    this.categoryParentIdentifier = value.Trim();
                }
            }
        }
