...
/// </example>
[Serializable]
public class RsdApplicationInterface : IComparable<RsdApplicationInterface>, IEquatable<RsdApplicationInterface>, IExtensibleSyndicationObject, IComparisonOperators
{
    /// <summary>
