...
/// <summary>
/// Records a feed a profile pays attention to, using <see cref="ApmlSource"/>.
/// </summary>
internal static class ApmlSourceExample
{
    /// <summary>
    /// Builds the containing <see cref="ApmlDocument"/> and prints the <see cref="ApmlSource"/> it holds.
    /// </summary>
