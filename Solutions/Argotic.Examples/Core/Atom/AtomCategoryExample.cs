...
/// </summary>
/// <remarks>
///     This class contains all the code examples that are referenced by the <see cref="AtomCategory"/> class. 
...
public static class AtomCategoryExample
{
    ...
    public static void ClassExample()
    {
        ...
        // Categorize the feed
        feed.Categories.Add(new("sports"));
        ...
        {
            Label = "Baseball",
            Scheme = new("http://example.org/scheme/category"),
            Term = "baseball"
        };
