namespace Argotic.Examples
{
    ...
    public static class CreativeCommonsSyndicationExtensionExample
    {
        ...
        public static void ClassExample()
        {
            ...
            {
                CreativeCommonsSyndicationExtension channelExtension =
                    feed.Channel.FindExtension(CreativeCommonsSyndicationExtension.MatchByType) as
            ...
            foreach (RssItem item in feed.Channel.Items)
            {
                ...
                {
                    CreativeCommonsSyndicationExtension itemExtension =
