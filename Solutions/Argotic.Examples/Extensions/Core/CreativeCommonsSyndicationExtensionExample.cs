...
/// </summary>
/// <remarks>
///     This class contains all the code examples that are referenced by the <see cref="CreativeCommonsSyndicationExtension"/> class. 
...
internal static class CreativeCommonsSyndicationExtensionExample
{
    ...
    public static void ClassExample()
    {
        ...
        int count = feed.Channel.Items.Count(i => i.FindExtension(CreativeCommonsSyndicationExtension.MatchByType) != null);
