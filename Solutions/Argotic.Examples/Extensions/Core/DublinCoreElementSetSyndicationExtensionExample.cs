...
/// <summary>
/// Reads a <see cref="DublinCoreElementSetSyndicationExtension"/> out of a feed the framework has already parsed, then writes the feed back out.
/// </summary>
/// <remarks>
...
/// </remarks>
internal static class DublinCoreElementSetSyndicationExtensionExample
{
    /// <summary>
    ...
    public static void ClassExample()
    {
        ...
        int count = feed.Channel.Items.Count(i => i.FindExtension(DublinCoreElementSetSyndicationExtension.MatchByType) is not null);
