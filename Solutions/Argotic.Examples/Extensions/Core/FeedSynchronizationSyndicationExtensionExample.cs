namespace Argotic.Examples
{
    ...
    /// <summary>
    /// Contains the code examples for the <see cref="FeedSynchronizationSyndicationExtension"/> class.
    /// </summary>
    /// <remarks>
    ///     This class contains all of the code examples that are referenced by the <see cref="FeedSynchronizationSyndicationExtension"/> class.
    ///     The code examples are imported using the unique #region identifier that matches the method or entity that the sample code describes.
    /// </remarks>
    public static class FeedSynchronizationSyndicationExtensionExample
    {
        /// <summary>
        /// Provides example code for the FeedSynchronizationSyndicationExtension class.
        /// </summary>
        public static void ClassExample()
        {
            ...
            {
                FeedSynchronizationSyndicationExtension channelExtension =
                    feed.Channel.FindExtension(FeedSynchronizationSyndicationExtension.MatchByType) as
            ...
            foreach (RssItem item in feed.Channel.Items)
            {
                ...
                {
                    FeedSynchronizationSyndicationExtension itemExtension =
                        item.FindExtension(FeedSynchronizationSyndicationExtension.MatchByType) as
                            FeedSynchronizationSyndicationExtension;
