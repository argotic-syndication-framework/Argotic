namespace Argotic.Extensions.Tests
{
    ...
    {
        private const string Namespc = @"xmlns:creativeCommons=""http://backend.userland.com/creativeCommonsRssModule""";

        private const string NycText =
            "<license xmlns=\"http://backend.userland.com/creativeCommonsRssModule\">http://www.example.com/license1.html</license>"
        ...
        /// Create context.
        /// </summary>
        /// <returns>Returns <see cref="CreativeCommonsSyndicationExtensionContext"/>.</returns>
        ...
        public void CreativeCommons_FullTest()
        {
            ...
            using (XmlReader reader = new XmlTextReader(strXml, XmlNodeType.Document, null))
            {
                ...
                Assert.IsInstanceOfType(
                    item.FindExtension(CreativeCommonsSyndicationExtension.MatchByType) as
        ...
        {
            CreativeCommonsSyndicationExtension
                target = new CreativeCommonsSyndicationExtension(); // TODO: Initialize to an appropriate value
...
// nav.Select("//item");
        ...
        /// <summary>
        /// Equality test for creative commons.
        /// </summary>
        ...
        /// Create extensions.
        /// </summary>
        /// <returns>Returns <see cref="CreativeCommonsSyndicationExtension"/>.</returns>
