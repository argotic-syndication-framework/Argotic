...
public class DublinCoreMetadataTermsSyndicationExtensionTest
{
    ...
    private readonly string toStringText = """
        <abstract xmlns="http://purl.org/dc/terms/">Test Abstract</abstract>
        <accessRights xmlns="http://purl.org/dc/terms/">Public</accessRights>
        <accrualMethod xmlns="http://purl.org/dc/terms/">Deposit</accrualMethod>
        <accrualPeriodicity xmlns="http://purl.org/dc/terms/">Monthly</accrualPeriodicity>
        <accrualPolicy xmlns="http://purl.org/dc/terms/">Active</accrualPolicy>
        <alternative xmlns="http://purl.org/dc/terms/">Alt Title</alternative>
        <audience xmlns="http://purl.org/dc/terms/">Developers</audience>
        <available xmlns="http://purl.org/dc/terms/">2010-08-01</available>
        <bibliographicCitation xmlns="http://purl.org/dc/terms/">Test Citation</bibliographicCitation>
        <conformsTo xmlns="http://purl.org/dc/terms/">ISO 9001</conformsTo>
        <contributor xmlns="http://purl.org/dc/terms/">Helper</contributor>
        <coverage xmlns="http://purl.org/dc/terms/">US</coverage>
        <created xmlns="http://purl.org/dc/terms/">2010-06-01T00:00:00.00Z</created>
        <creator xmlns="http://purl.org/dc/terms/">The Big Guy</creator>
        <date xmlns="http://purl.org/dc/terms/">2010-08-01T00:00:00.00Z</date>
        <dateAccepted xmlns="http://purl.org/dc/terms/">2010-07-01T00:00:00.00Z</dateAccepted>
        <dateCopyrighted xmlns="http://purl.org/dc/terms/">2010-01-01T00:00:00.00Z</dateCopyrighted>
        <dateSubmitted xmlns="http://purl.org/dc/terms/">2010-05-01T00:00:00.00Z</dateSubmitted>
        <description xmlns="http://purl.org/dc/terms/">That kind of thing</description>
        <educationLevel xmlns="http://purl.org/dc/terms/">Graduate</educationLevel>
        <extent xmlns="http://purl.org/dc/terms/">100 pages</extent>
        <format xmlns="http://purl.org/dc/terms/">application/pdf</format>
        <hasFormat xmlns="http://purl.org/dc/terms/">urn:format:html</hasFormat>
        <hasPart xmlns="http://purl.org/dc/terms/">Chapter 1</hasPart>
        <hasVersion xmlns="http://purl.org/dc/terms/">2.0</hasVersion>
        <identifier xmlns="http://purl.org/dc/terms/">MYTESTCDROM-1</identifier>
        <instructionalMethod xmlns="http://purl.org/dc/terms/">Lecture</instructionalMethod>
        <isFormatOf xmlns="http://purl.org/dc/terms/">urn:original</isFormatOf>
        <isPartOf xmlns="http://purl.org/dc/terms/">Collection A</isPartOf>
        <isReferencedBy xmlns="http://purl.org/dc/terms/">urn:reference</isReferencedBy>
        <isReplacedBy xmlns="http://purl.org/dc/terms/">urn:replacement</isReplacedBy>
        <isRequiredBy xmlns="http://purl.org/dc/terms/">urn:dependent</isRequiredBy>
        <issued xmlns="http://purl.org/dc/terms/">2010-09-01T00:00:00.00Z</issued>
        <isVersionOf xmlns="http://purl.org/dc/terms/">urn:original:v1</isVersionOf>
        <language xmlns="http://purl.org/dc/terms/">en-US</language>
        <license xmlns="http://purl.org/dc/terms/">MIT License</license>
        <mediator xmlns="http://purl.org/dc/terms/">Teacher</mediator>
        <medium xmlns="http://purl.org/dc/terms/">Paper</medium>
        <modified xmlns="http://purl.org/dc/terms/">2010-10-01T00:00:00.00Z</modified>
        <provenance xmlns="http://purl.org/dc/terms/">Original ownership</provenance>
        <publisher xmlns="http://purl.org/dc/terms/">MeMeMe</publisher>
        <references xmlns="http://purl.org/dc/terms/">urn:ref1</references>
        <relation xmlns="http://purl.org/dc/terms/">MYTESTCDROM-2</relation>
        <replaces xmlns="http://purl.org/dc/terms/">urn:old</replaces>
        <requires xmlns="http://purl.org/dc/terms/">urn:dependency</requires>
        <rights xmlns="http://purl.org/dc/terms/">Copyright 2010</rights>
        <rightsHolder xmlns="http://purl.org/dc/terms/">Test Corp</rightsHolder>
        <source xmlns="http://purl.org/dc/terms/">Out of Me Head</source>
        <spatial xmlns="http://purl.org/dc/terms/">New York</spatial>
        <subject xmlns="http://purl.org/dc/terms/">Test data (Stupid variety)</subject>
        <tableOfContents xmlns="http://purl.org/dc/terms/">Chapter 1; Chapter 2</tableOfContents>
        <temporal xmlns="http://purl.org/dc/terms/">20th Century</temporal>
        <title xmlns="http://purl.org/dc/terms/">Stupid test data</title>
        <type xmlns="http://purl.org/dc/terms/">Text</type>
