...
public class FeedSynchronizationSyndicationExtensionTest
{
    ...
    [TestMethod]
    public void FeedSynchronizationHistory_OperatorLessThan_Works()
    {
        // Arrange
        FeedSynchronizationHistory history1 = new(1);
        FeedSynchronizationHistory history2 = new(2);

        // Act
        bool result = history1 < history2;
    ...
    [TestMethod]
    public void FeedSynchronizationHistory_OperatorGreaterThan_Works()
    {
        // Arrange
        FeedSynchronizationHistory history1 = new(2);
        FeedSynchronizationHistory history2 = new(1);
