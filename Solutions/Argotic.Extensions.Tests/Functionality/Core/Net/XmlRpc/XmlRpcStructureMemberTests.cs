...
public class XmlRpcStructureMemberTests
{
    ...
    {
        // Arrange
        XmlRpcStructureMember member1 = new XmlRpcStructureMember("zzz", new XmlRpcScalarValue("value"));
        XmlRpcStructureMember member2 = new XmlRpcStructureMember("aaa", new XmlRpcScalarValue("value"));
