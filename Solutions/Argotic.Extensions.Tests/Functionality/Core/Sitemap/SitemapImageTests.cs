...
public class SitemapImageTests
{
    ...
    {
        // Arrange
        SitemapImage image1 = new(new Uri("https://example.com/b.jpg"));
        SitemapImage image2 = new(new Uri("https://example.com/a.jpg"));
    ...
    [TestMethod]
    public void OperatorGreaterThan_GreaterValue_ReturnsTrue()
    {
        // Arrange
        SitemapImage image1 = new(new Uri("https://example.com/b.jpg"));
        SitemapImage image2 = new(new Uri("https://example.com/a.jpg"));
    ...
    [TestMethod]
    public void OperatorGreaterThan_LesserValue_ReturnsFalse()
    {
        // Arrange
        SitemapImage image1 = new(new Uri("https://example.com/a.jpg"));
        SitemapImage image2 = new(new Uri("https://example.com/b.jpg"));
