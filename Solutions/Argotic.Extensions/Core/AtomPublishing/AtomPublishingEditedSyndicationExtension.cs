...
/// <summary>
/// Extends syndication specifications to provide a means of specifying a date construct whose content indicates the last time a resource was edited.
/// </summary>
/// <remarks>
///     <para>
...
public class AtomPublishingEditedSyndicationExtension : SyndicationExtension, IComparable<AtomPublishingEditedSyndicationExtension>, IEquatable<AtomPublishingEditedSyndicationExtension>, IComparisonOperators
{
    ...
    public AtomPublishingEditedSyndicationExtension()
        : base("app", "http://www.w3.org/2007/app", new Version("1.0"), new Uri("https://www.rfc-editor.org/rfc/rfc5023.html"), "Atom Publishing Protocol Editing", "Extends syndication resource memebers to provide a means of specifying a date construct whose content indicates the last time a resource was edited.")
    {
    }
    ...
    public int CompareTo(AtomPublishingEditedSyndicationExtension? other)
    {
        if (other is null)
        {
            return 1;
