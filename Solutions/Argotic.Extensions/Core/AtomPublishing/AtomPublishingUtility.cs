namespace Argotic.Extensions.Core
{
    ...
    internal static class AtomPublishingUtility
    {
        ...
        /// </summary>
        private const string AtompubNamespace = "http://www.w3.org/2007/app";
        ...
        public static XmlNamespaceManager CreateNamespaceManager(XmlNameTable nameTable)
        {
            ...
            manager.AddNamespace("atom", !string.IsNullOrEmpty(manager.DefaultNamespace) ? manager.DefaultNamespace : AtomNamespace);
            manager.AddNamespace("app", AtompubNamespace);
        ...
        public static void WriteCommonObjectAttributes(IAtomPublishingCommonObjectAttributes source, XmlWriter writer)
        {
            ...
            {
                writer.WriteAttributeString("xml", "base", XmlNamespace, source.BaseUri.ToString());
            }

            if (source.Language != null)
            {
                writer.WriteAttributeString("xml", "lang", XmlNamespace, source.Language.Name);
            }
        }
    }
}