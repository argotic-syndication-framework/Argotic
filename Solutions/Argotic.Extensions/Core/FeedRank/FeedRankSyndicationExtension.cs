namespace Argotic.Extensions.Core
{
    ...
    ///         <code source="..\..\Argotic.Examples\Extensions\Core\FeedRankSyndicationExtensionExample.cs" region="FeedRankSyndicationExtension" />
    ///     </code>
    /// </example>
    [Serializable]
    public class FeedRankSyndicationExtension : SyndicationExtension, IComparable
    {
        ...
        public static bool MatchByType(ISyndicationExtension extension)
        {
            ...
            return extension.GetType() == typeof(FeedRankSyndicationExtension);
        }
