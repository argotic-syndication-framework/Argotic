...
public class FeedSynchronizationHistory : IComparable<FeedSynchronizationHistory>, IEquatable<FeedSynchronizationHistory>, IComparisonOperators
{
    ...
    public override int GetHashCode() => HashCode.Combine(HashCodeUtility.Component(this.By), HashCodeUtility.Component(this.Sequence), HashCodeUtility.Component(this.When));
