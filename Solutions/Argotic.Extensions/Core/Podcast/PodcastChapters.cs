...
public class PodcastChapters : IComparable<PodcastChapters>, IEquatable<PodcastChapters>, IComparisonOperators
{
    ...
    /// <returns><see langword="true"/> if the <see cref="PodcastChapters"/> was initialized using the supplied <paramref name="source"/>; otherwise, <see langword="false"/>.</returns>
