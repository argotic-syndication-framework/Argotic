...
/// </example>
[Serializable]
public class SimpleListSyndicationExtension : SyndicationExtension, IComparable, IEquatable<SimpleListSyndicationExtension>
{
    ...
    {
        return obj is SimpleListSyndicationExtension other && this.Equals(other);
    }
