namespace Argotic.Extensions.Core
{
    ...
    ///         <code source="..\..\Argotic.Examples\Extensions\Core\SiteSummarySlashSyndicationExtensionExample.cs" region="SiteSummarySlashSyndicationExtension" />
    ///     </code>
    /// </example>
    [Serializable]
    public class SiteSummarySlashSyndicationExtension : SyndicationExtension, IComparable
    {
        ...
        public static bool MatchByType(ISyndicationExtension extension)
        {
            ...
            return extension.GetType() == typeof(SiteSummarySlashSyndicationExtension);
        }
