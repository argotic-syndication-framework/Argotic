...
/// </remarks>
[Serializable]
public class YahooMediaCopyright : IComparable<YahooMediaCopyright>, IEquatable<YahooMediaCopyright>
{
    ...
    {
        return obj is YahooMediaCopyright other && this.Equals(other);
    }
